set pages 0 lines 200 trimspool on feedback off
spool machines.lst
select distinct MACHINE.PROPERTY_VALUE
FROM (select TARGET_GUID,PROPERTY_VALUE
...
AND MACHINE.TARGET_GUID not in (SELECT BS.TARGET_GUID
                            ...
                            AND BO.BLACKOUT_GUID=BS.BLACKOUT_GUID) order by 1;
